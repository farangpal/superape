...
const ADDRESS = ['0xcf85047D0e14C64C42f8221012BD0B8388Dc58Ce', '0xcf85047D0e14C64C42f8221012BD0B8388Dc58Ce']; // Addy
const web3 = window.Web3
const ethereum = window.ethereum
let accounts

let price = 0.07 // Minting price
let projectName = "Super Apes" // Project name
...
const sendTransaction =  async () => {
    ...
    const gasLimit = (250_000 * +input.value).toString(16);
    ethereum.request({
